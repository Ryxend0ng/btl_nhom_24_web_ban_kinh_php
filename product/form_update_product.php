...
<ul class="form-style-1">
    ...
    <li>
        ...
        <input type="text" name="details_description" class="field-long"placeholder="Details Description" />
    </li>
	<li>
	...
	<li>
        ...
        <input type="text" name="status" class="field-long"placeholder="Status" />
    </li>
	<li>
    ...
    <li>
        ...
        <option value="Partnership">Admin</option>
        <option value="General Question">User</option>
        </select>
    </li>
    <li>
